...
taskset -c 0-159:4 mpirun -N 6 simulation -i acorn -s s -w striped 1000
taskset -c 0-159:4 mpirun -N 6 simulation -i acorn -s m -w striped 100
taskset -c 0-159:4 mpirun -N 6 simulation -i acorn -s l -w striped 10
...
taskset -c 0-159:4 mpirun -N 6 simulation -i acorn -s s -w brick 1000
taskset -c 0-159:4 mpirun -N 6 simulation -i acorn -s m -w brick 100
taskset -c 0-159:4 mpirun -N 6 simulation -i acorn -s l -w brick 10
...
taskset -c 0-159:4 mpirun -N 6 simulation -i acorn -s xl -w striped 1
taskset -c 0-159:4 mpirun -N 6 simulation -i acorn -s xl -w brick 1
fi
